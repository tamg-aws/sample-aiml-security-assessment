...
Run **[218 checks](docs/SECURITY_CHECKS.md)** across AWS accounts and regions:

- **104 always-on core checks** for Amazon Bedrock, Amazon SageMaker AI, Amazon Bedrock AgentCore, and AWS Agent Registry
...
- **[218 Security Checks](docs/SECURITY_CHECKS.md)** across Amazon Bedrock, Amazon SageMaker AI, Amazon Bedrock AgentCore, AWS Agent Registry, Agentic AI Security, Responsible AI GRC, and OWASP Top 10 for LLM
...
| **Inconsistent security checks across teams** | Standardized 218-check assessment based on AWS Well-Architected Generative AI Lens and Agentic AI Lens best practices, AWS Responsible AI governance/risk/compliance guidance, and OWASP Top 10 for LLM |
...
**218 checks across seven areas.** The assessment covers Amazon Bedrock, Amazon SageMaker AI, Amazon Bedrock AgentCore, AWS Agent Registry, always-on Agentic AI Security, optional Responsible AI GRC checks, and optional OWASP Top 10 for LLM checks. Other AI/ML services (Amazon Comprehend, Amazon Rekognition, Amazon Textract, and others) are not currently assessed.
...
| [Security Checks Reference](docs/SECURITY_CHECKS.md) | Complete reference for all 218 security checks with severity levels |
...
| [AWS AI Security Framework (AISF) Checks](docs/SECURITY_CHECKS_AISF.md) | Complete AISF-00..08 reference: the AISF control each row reports on, the shipped checks each is derived from, severity and status semantics, and why these rows are excluded from the 218-check total |
