...
COMPLIANCE_STANDARDS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "scope_text": (
            ...
            "narrower claim than coverage: 61 of the 78 are covered by checks "
            "that already ship, and the 53 covered controls without a row are "
            ...
            "framework's 249-check total. AISF-00 marks an account and region "
