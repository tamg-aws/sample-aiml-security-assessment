...
framework already provides 104 core security checks (33 SageMaker checks through SM-34 with SM-29 reserved, BR-01 to BR-46, AC-01 to AC-17, and AR-01 to AR-08) and 38 always-on Agentic AI Security checks (AG-01 to AG-38).
...
After FinServ consolidation the framework contains **104 upstream + 38 AG + 64 FS = 206 distinct checks** before optional OWASP checks. With the 12 optional OWASP Top 10 for LLM checks enabled, the full catalog contains **218 distinct checks**. The FinServ consolidation reduces duplication without losing FinServ-specific regulatory depth.
